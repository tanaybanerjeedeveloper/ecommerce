...
class ProductScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // final productsRepositpry = ref.watch(fakeProductsRepositoryProvider);
    // final product = productsRepositpry.getProduct(productId);

    return Scaffold(
      appBar: const HomeAppBar(),
      body: Consumer(
        builder: (context, ref, _) {
          final productAsyncValue = ref.watch(watchProductProvider(productId));
